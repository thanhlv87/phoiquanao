        ...
        const response = await ai.models.generateContent({
            ...
            contents: {
                parts: [
                    ...
                    { text: 'Hãy tạo ra một hình ảnh chân thực (photorealistic): Ghép chiếc áo từ hình 2 và chiếc quần/váy từ hình 3 lên người mẫu ở hình 1. Giữ nguyên tư thế, khuôn mặt và bối cảnh của người mẫu. Ánh sáng và đổ bóng phải tự nhiên để trông như người mẫu đang thực sự mặc bộ đồ đó. Tuyệt đối không thay đổi người mẫu. Chỉ trả về 1 hình ảnh kết quả.' },
                ],
            },
